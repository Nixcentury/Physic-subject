...
3. `public/pages/physics.js` — การเลือกบทและขอเปิดงานของหน้า Physics
...
- หน้า Physics มี Navigation 3 ชั้น ช่องบทเริ่มต้น 4 บท และรายการงานตัวอย่าง
...
สถานะปัจจุบัน: **Round 4B มีชั้นเลือกงาน หน้าต่างลอย และแถบงานกลางแล้ว**
...
Round ถัดไปสามารถเลือกได้ว่าจะขยายโครงนี้ไปยังวิชาอื่น หรือเริ่มออกแบบชิ้นส่วนเนื้อหาใหม่ชิ้นแรก โดยยังไม่จำเป็นต้องเชื่อม Quiz เดิม
